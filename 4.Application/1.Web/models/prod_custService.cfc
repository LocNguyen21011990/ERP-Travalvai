  ...
  property name='userService'       inject='userService';
	...
	*/
    ...
    function getProdCus(productid){
      ...
      if(usertype neq 4){
         result = QueryExecute("
            select costing.cost_code, prod_cust.id_plz_det, prod_cust.id_prd_cust, prod_cust.prd_cust_qtty, cvd.cvd_description cv_version, prod_cust.id_product, prod_cust.prd_cust_description
            from prod_cust
              join costing 
