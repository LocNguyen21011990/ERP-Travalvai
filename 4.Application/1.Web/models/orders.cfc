component persistent="true" {
	...
	property name="ord_units" 			ormtype="double" default=0;
	...
	property name="ord_discount_1" 		ormtype="integer" default=0;
	property name="ord_discount_2" 		ormtype="integer" default=0;
	...
	property name="order_type"    		fieldtype="many-to-one"  	cfc="order_type"           			fkcolumn="id_order_type" cascade="all";
	property name="order_condition"   	fieldtype="many-to-one"  	cfc="order_condition"           	fkcolumn="id_order_condition" cascade="all";
	property name="order_status"   		fieldtype="many-to-one"  	cfc="order_status"           		fkcolumn="id_order_status" cascade="all";
