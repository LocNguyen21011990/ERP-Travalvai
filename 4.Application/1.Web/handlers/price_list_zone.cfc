		...
		if(event.GETHTTPMETHOD() == "POST")
		{
			transaction {
				try {
					...
					var plzSource= price_list_zoneService.get(id=rc.sourceplz);
					...
					if(isnull(checkplz)) {
						...
						newplz.setplz_code(isNull(rc.code)?"":rc.code);
						...
						newplz.setplz_ex_Rate(isNull(rc.ex_rate)?"":rc.ex_rate);
						...
						for(item_plfd in plf_det) {
							...
							new_plzdetail.setplzd_Fty_Sell_4(item_plfd.getplfd_fty_sell_3() * plzcc_value/plfcc_value);
							new_plzdetail.setplzd_Freight(new_plzdetail.getplzd_Weight() * newplz.getplz_freight()/1000);
							new_plzdetail.setplzd_Taxes((new_plzdetail.getplzd_Fty_Sell_4() + new_plzdetail.getplzd_Freight()) * newplz.getplz_taxes() / 100);
							new_plzdetail.setplzd_Margin((newplz.getplz_margin()/100) * (new_plzdetail.getplzd_Fty_Sell_4() + new_plzdetail.getplzd_Freight() + new_plzdetail.getplzd_Taxes()));
							new_plzdetail.setplzd_Zone_Sell_5(new_plzdetail.getplzd_Fty_Sell_4() + new_plzdetail.getplzd_Freight() + new_plzdetail.getplzd_Taxes() + new_plzdetail.getplzd_Margin());
							new_plzdetail.setplzd_Zone_Sell_6(new_plzdetail.getplzd_Zone_Sell_5());
							new_plzdetail.setplzd_Margin_1((new_plzdetail.getplzd_Zone_Sell_6() - new_plzdetail.getplzd_Fty_Sell_4() - new_plzdetail.getplzd_Freight() - new_plzdetail.getplzd_Taxes())*100/(new_plzdetail.getplzd_Fty_Sell_4() + new_plzdetail.getplzd_Freight() + new_plzdetail.getplzd_taxes()));
							new_plzdetail.setplzd_PVPR_7(new_plzdetail.getplzd_Zone_Sell_6() * 100 / (100 - newplz.getPlz_margin()));
							new_plzdetail.setplzd_PVPR_8(new_plzdetail.getplzd_PVPR_7());
							new_plzdetail.setplzd_Margin_2((new_plzdetail.getplzd_PVPR_8() - new_plzdetail.getplzd_Zone_Sell_6())*100/new_plzdetail.getplzd_PVPR_8());
						...
						event.renderData(type="json",data={ 'success' : true , 'message' : 'Copy data successfully'});
						}else{
			...
			try {
				...
				if(isnull(checkplz)) {
					...
					for(item_plfd in plf_det) {
						...
						var plzd_pvpr_7 = val(numberService.roundDecimalPlaces(plzd_zone_sell_6*100/(100 - newplz.getplz_margin()),2));
