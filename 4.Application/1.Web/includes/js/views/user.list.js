(function(){
  ...
  function BindAngularDirectiveCtrl($scope , $http, $filter ,$compile, DTOptionsBuilder, DTColumnBuilder)
  {
     var vm         = this;
      ...
      vm.userInfo = {};
      var sumColumnFilter = {'0' : {type : 'text'}, '1' : {type : 'text'}, '2' : {type : 'text'}, '3' : {type : 'text'}, '4' : {type : 'text'}, '5' : {type : 'text'}, '6' : {type : 'text'}, '7' : {type : 'text'}, '8' : {type : 'text'}};
      vm.dtColumns = [
    ...
    function showAddNew (argument) {
      ...
      function actionsHtml(data, type, full, meta) {
          ...
          return '<span class="txt-color-green btnedit padding-right-30" title="Edit" ng-click="showCase.editRow(showCase.users[' + data.ID + '])">' +
