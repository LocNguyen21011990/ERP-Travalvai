(function(){
  angular.module('zone.List', ['Formcontact','datatables', 'datatables.light-columnfilter']).controller("BindAngularDirectiveCtrl",BindAngularDirectiveCtrl)
  ...
  function BindAngularDirectiveCtrl($scope ,$http , $filter,$compile, DTOptionsBuilder, DTColumnBuilder)
  {
    ...
    //     async: false,
    //     type: 'GET',
    //     url: '/index.cfm/basicdata/getZoneRight',
