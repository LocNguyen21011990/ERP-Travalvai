(function(){
  angular.module('typeCustomer', ['datatables', 'datatables.light-columnfilter']).controller("BindAngularDirectiveCtrl",BindAngularDirectiveCtrl)
  ...
  function BindAngularDirectiveCtrl($scope ,$http, $filter,$compile, DTOptionsBuilder, DTColumnBuilder)
  {
     var vm         = this;
      ...
      vm.dtColumns = [
          DTColumnBuilder.newColumn('id_type_Customer').withTitle('ID'),
