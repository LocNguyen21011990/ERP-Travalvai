    					...
    					<div class="widget-body"  >
    						<div class="row">
                								...
                								<div class="fcontent">
                									<form class="form-horizontal">
                										...
                										<div class="form-group" ng-class="{'has-error':userForm.forwarder.$invalid && !userForm.forwarder.$pristine}">
                											<label class="col-md-3 control-label text-left">Forwarder</label>
                											<div class="col-md-9">
    							...
    							<div class="row width-table-content">
    								<fieldset>
    									<div class="col-md-10"><legend class="fcollapsible">Forwarder List</legend></div>
...
<script src="/includes/js/views/forwarder.list.js"></script>
