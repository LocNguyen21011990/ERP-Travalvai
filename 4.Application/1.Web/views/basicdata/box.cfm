			...
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false">
				...
				<div>
					...
					<div class="widget-body">
						...
						<div class="row">
							<div class="col-md-6">
								<legend class="fcollapsible">Box Detail</legend>
								<div class="fcontent">
									<form class="form-horizontal">
										<div class="form-group">
											<label class="col-md-3 control-label tex-left">Box</label>
											<div class="col-md-9">
												<input class="form-control" placeholder="" type="text" name="" id="textName">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label tex-left">Type Box</label>
											<div class="col-md-9">
										...
										<div class="form-group">
											<label class="col-md-3 control-label tex-left">Weight</label>
											<div class="col-md-9">
							...
							<div class="col-md-6">
								<fieldset>
									<legend class="fcollapsible">Box List</legend>
