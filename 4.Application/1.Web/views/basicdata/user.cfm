					...
					<div class="widget-body">
						...
						<div class="row">
											...
											<div class="fcontent">
												<form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
													...
													<div class="form-group" ng-class="{'has-error':userForm.name.$invalid && !userForm.name.$pristine}">
				                                        ...
				                                        <div class="col-md-5">
				                                            <input class="form-control" placeholder="" type="text" name="name" id="name" ng-model="showCase.user.name" required>
			                                                <p ng-show="userForm.name.$error.required && !userForm.name.$pristine" class="help-block">Name is required</p>
				                                        </div>
				                                    </div>
													<div class="form-group" ng-class="{'has-error' : userForm.password.$invalid && !userForm.password.$pristine}">
														<label class="col-md-3 control-label text-left">Password</label>
														<div class="col-md-5">
															<input class="form-control" placeholder="" type="text" name="password" id="password" ng-model="showCase.user.password">
													...
													<div class="form-group" ng-class="{'has-error' : userForm.position.$invalid && !userForm.position.$pristine}">
														<label class="control-label col-md-3 text-left">Position</label>
														<div class="col-md-5">
							...
							<div class="row width-table-content">
								<fieldset>
									<div class="col-md-10"><legend class="fcollapsible">User List</legend></div>
...
<script src="/includes/js/views/user.list.js"></script>
