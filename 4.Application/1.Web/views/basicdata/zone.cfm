					...
					<div class="widget-body" >
						...
						<div class="row">
											...
											<div class="fcontent">
			                                    ...
			                                    <div class="form-group" ng-class="{'has-error':userForm.description.$invalid && !userForm.description.$pristine}">
			                                    	...
			                                    	<div class="form-group" style="display:none">
														<label class="control-label col-md-3 text-left">Factory</label>
														<div class="col-md-5">
													...
													<div class="form-group">
														<!--- <label class="col-md-3 control-label text-left">Contact</label> --->
														<!--- <div class="col-md-5">
															<select class="form-control" id="contact" name="contact" ng-model="showCase.user.contactID" ng-options="lang.ID as lang.NAME for lang in showCase.contacts" required>
																<option value="">Choose</option>
															</select>
															<p ng-show="userForm.contact.$invalid && !userForm.contact.$pristine" class="help-block">Please choose contact</p>
														</div> --->
														<label class="col-md-3 control-label text-left">Contact</label>
														<div class="col-md-5">
															<input class="form-control" readonly placeholder="" type="text" name="contact" id="contact" ng-model="showCase.user.contact" required>
															<!--- <input class="form-control" readonly placeholder="" type="text" id="zoneContactID" ng-model="showCase.contactID"> --->
															<!--- <input class="form-control" readonly placeholder="" type="text" name="contact" id="contact" value="{{showCase.contact}}"> --->
														</div>
														<div class="col-md-3">
													...
													<div class="form-group text-center">
														...
														<div class="btn btn-default" id="btnRefresh" ng-click="showCase.refreshZone()">
							...
							<div class="row width-table-content">
								<fieldset>
									<div class="col-md-10"><legend class="fcollapsible">Zone List</legend></div>
									<div class="btn col-md-2 bg-color-blueDark txt-color-white" id="btnAddNew" ng-click="showCase.showAddNew()" style="display:none">
