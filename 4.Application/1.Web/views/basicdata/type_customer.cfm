                    ...
                    <div class="widget-body">
                        ...
                        <div class="row">
                                            ...
                                            <div class="fcontent">
                                                <form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
                                                    ...
                                                    <!--- <div class="form-group" ng-class="{'has-error' : userForm.code.$invalid && !userForm.code.$pristine}">
                                                        <label class="col-md-2 control-label text-left">Code</label>
                                                        <div class="col-md-10">
                                                            ...
                                                            <p ng-show="userForm.code.$invalid && !userForm.code.$pristine" class="help-block">Code is required</p>
                            ...
                            <div class="row width-table-content">
                                <fieldset>
                                    <div class="col-md-10"><legend class="fcollapsible">Type of Customer List</legend></div>
...
<script src="/includes/js/views/type_customer.list.js"></script>