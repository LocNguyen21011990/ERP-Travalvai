					...
					<div class="widget-body" >
						<div class="row">
											...
											<div class="fcontent">
												<form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
													...
													<div class="form-group" ng-class="{'has-error':userForm.commission.$invalid && !userForm.commission.$pristine}">
														<label class="col-md-3 control-label text-left">Commission</label>
														<div class="col-md-9">
													...
													<!--- <div class="form-group">
														<label class="col-md-3 control-label text-left">Price List</label>
														<div class="col-md-9">
															<select class="form-control" id="priceList" name="plz" >
																<option value="">Choose</option>
															</select>
														</div>
													</div> --->
							...
							<div class="row width-table-content">
								<fieldset>
									<div class="col-md-10"><legend class="fcollapsible">Agent List</legend></div>
...
<script src="/includes/js/views/agent.list.js"></script>
