					...
					<div class="widget-body" >
						...
						<div class="row">
											...
											<div class="fcontent">
												<form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
													...
													<div class="form-group" style="display:none;">
				                                        ...
				                                        <!--- <label class="col-md-9 control-label text-left" name="code" id="code" ng-model="showCase.user.code">{{showCase.code}}</label> --->
													...
													<div class="form-group" style="display:none">
														...
														<div class="col-md-9">
															<select class="form-control" id="agent" ng-model="showCase.user.agent" ng-options="agent.ID as agent.DES for agent in showCase.agents" >
																<option value="">Choose</option>
															</select>
														</div>
													</div>
													<div class="form-group" style="display:none">
														<label class="control-label col-sm-3 text-left">Zone</label>
												    	<div class="col-sm-9">
													...
													<div class="form-group" ng-class="{'has-error':userForm.type.$invalid && !userForm.type.$pristine}">
														<label class="control-label col-md-3 text-left">Type</label>
														<div class="col-md-9">
															<select class="form-control" id="type" name="type" ng-model="showCase.user.toc" ng-options="toc.id_type_Customer as toc.tc_description for toc in showCase.tocs" required>
																<option value="">Choose</option>
															</select>
															<p ng-show="userForm.language.$invalid && !userForm.language.$pristine" class="help-block">Please choose language</p>
														</div>
							...
							<div class="row width-table-content">
								<fieldset>
									<div class="col-md-10"><legend class="fcollapsible">Customer List</legend></div>
...
<script src="/includes/js/views/customer.list.js"></script>
