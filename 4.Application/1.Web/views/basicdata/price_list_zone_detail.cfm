    ...
    <div class="row">
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false">
                <header >
                	<a class="widget-icon" href="/index.cfm/basicdata.price_list_zone" title="Back to cost list">
                    <span class="widget-icon" style="color:white;"> <i class="fa fa-arrow-left"></i> </span></a>
                ...
                <div>
                    <div class="widget-body">
                        <div class="row">
                        	<fieldset>
                            	<legend class="fcollapsible" style="padding-left:10px;">Price List Zone Information</legend>
                            	<div class="fcontent">
									<form class="form-horizontal col-md-12" name="userForm" id="userForm" ng-submit="showCase.submitForm()" novalidate>
										...
										<div class="row margin-top-20">
			                            	<div class="col-md-12 text-right">
				                            	<div class="btn bg-color-blueDark txt-color-white" id="btnAddNew" ng-click="showCase.UpdatePLZ()" ng-disabled="userForm.$invalid">
			                                    <i class="fa fa-save"></i>&nbsp;SAVE</div>
				                            </div>
										</div>
			                        </form>
                            	</div>
                        ...
                        <div class="row">
                        	<legend class="fcollapsible" style="padding-left:10px;">Price List Zone Detail</legend>
                            <div class="fcontent">
                            	<div>
