                                            ...
                                            <div class="fcontent">
                                                <form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            <input type="file" id="pr_sketch" name="pr_sketch" multiple onchange="angular.element(this).scope().uploadFile(this.files)"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <form class="form-horizontal" name="userForm1" ng-submit="showCase.submitForm()" novalidate>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3" ng-class="{'has-error' : userForm1.productType.$invalid && !userForm1.productType.$pristine}">
                                                            ...
                                                            <p ng-show="userForm1.productType.$invalid && !userForm1.productType.$pristine" class="help-block">Required</p>
                                                        </div>

                                                        <input class="col-md-1" type="radio" name="radiobutton" ng-model="showCase.kindOfCopy.type" id="costing" value="costing" ng-change="showCase.typeCostingAction();">

                                                        <div class="col-md-3" ng-class="{'has-error' : userForm1.oCode.$invalid && !userForm1.oCode.$pristine}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <div class="col-md-4" ng-class="{'has-error' : userForm1.sameCode.$invalid && !userForm1.sameCode.$pristine}">
                                                                <input class="form-control" placeholder="Cost Code" type="text" name="sameCode" id="sameCode" ng-model="showCase.user.sameCode" ng-required="showCase.isRequiredSameCode" ng-disabled="showCase.sameCodeIsDisable">
                                                                <p ng-show="userForm1.sameCode.$invalid && !userForm1.sameCode.$pristine" class="help-block">Required</p>
                                                            </div>
                                                        </div>

                                                        <div class="col-md-2" ng-class="{'has-error':userForm1.increase.$invalid && !userForm1.increase.$pristine}" style="padding-right:2px;">
                                                        ...
                                                        <label class="col-md-2 control-label text-left" style="padding-left:0px;">% Increase</label>
                                                    </div>
                                                    <div class="form-group">
