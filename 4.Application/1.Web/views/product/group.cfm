                    ...
                    <div class="widget-body">
                        <div class="row">
                                            ...
                                            <div class="fcontent">
                                                <form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="checkbox" id="checkboxdes" name="checkboxdes" checked> Use English for all  Descriptions
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <div class="row width-table-content">
                                <fieldset>
                                    <div class="col-md-10"><legend class="fcollapsible">Group of Product</legend></div>
...
<script src="/includes/js/views/product.group.js"></script>
