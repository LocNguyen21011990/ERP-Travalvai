						...
						<form class="form-horizontal">
							...
							<div class="row form-actions">
								<div class="col-md-12 text-center">
									<div class="btn bg-color-blueDark txt-color-white" id="btnSave" ng-disabled="!showCase.editing" ng-click="showCase.saveDetail()">
										<i class="fa fa-save"></i>
										&nbsp;Save
									</div>
									<div class="btn btn-default" ng-click="showCase.quit()">
